...
export default function QuizCard() {
  const { handleCreateNewSession } = useContext(QuestionContext);
          ...
          <div className="h-full dark:bg-oxford-blue border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden ">
            ...
            <div className="">
              ...
              <div className="p-4 flex items-center justify-between">
                ...
                <button
                  onClick={() => handleCreateNewSession("javascript")}
          ...
          <div className="h-full dark:bg-oxford-blue border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden ">
            ...
            <div className="">
              ...
              <div className="p-4 flex items-center justify-between">
                ...
                <button
                  onClick={() => handleCreateNewSession("nodejs")}
                  className="pointer-cursor bg-btn-majorelle-blue border-2 border-bg-menu-dark-silver-metallic py-2 px-6 rounded hover:bg-link-violet-blue"
                >
                  Start Quiz
                </button>
