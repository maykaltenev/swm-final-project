...
//   console.log("first", currentQuestion);
//   const handlePrevious = () => {
//     setCurrentQuestion(id);
//     console.log("id from Previous", currentQuestion);
...
//     navigate(`/mypage/${id * 1 < id.length - 1 ? id * 1 + 1 : id}`);
//   };
...
//             src={
//               questionData[currentQuestion]?.questionType === "javascript"
//                 ? jsimg
//                 : questionData[currentQuestion]?.questionType === "react"
//                 ? reactimg
//                 : questionData[currentQuestion]?.questionType === "express"
//                 ? expressimg
//                 : questionData[currentQuestion]?.questionType === "mongodb"
//                 ? mongodbimg
//                 : questionData[currentQuestion]?.questionType === "nodejs"
//                 ? nodeimg
//                 : ""
//             }
//             alt="quiz"
...
//             bg-btn-majorelle-blue dark:bg-cyber-yellow dark:text-git-box hover:shadow-lg focus:bg-gray-500 focus:shadow-lg focus:outline-none focus:ring-0 transition duration-150 ease-in-out"
...
//             bg-btn-majorelle-blue dark:bg-cyber-yellow dark:text-git-box hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0  transition duration-150 ease-in-out"
//               onClick={handleNext}
//             >
//               Next
//             </button>
