  ...
  return (
    ...
    >
      {questionData.map((question, i) => (
        <div
          className="pointer w-3 h-3 p-3 sm:w-4 sm:h-4 sm:p-4 border-2 border-full sm:border-l-2 sm:border-r-2 rounded-full p-3 flex justify-center items-center text-snow lg:border-4 lg:text-xl"
          style={{
