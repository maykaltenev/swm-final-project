  ...
  return (
    ...
    >
      {questionData.map((question, i) => (
        <div
          // border-full sm:border-l-2 sm:border-r-2 rounded-full
          // lg:border-4
          className="pointer text-bg-git-nav w-3 h-3 p-3 sm:w-4 sm:h-4 sm:p-4 border-b-2 border-r rounded-xl shadow-6xl p-3 flex justify-center items-center dark:text-git-nav lg:text-xl"
          style={{
